...
17\texttimes{} end-to-end speedup with no quality loss. Throughput scales
with environment count rather than saturating, and the same code runs on GPU
where the gap is expected to widen to 100\texttimes{}+. The pure-JAX
environment and scan-based PPO implementation are available in the
